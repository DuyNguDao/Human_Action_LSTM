...
class Track:
    ...
    def __init__(self, detection, track_id, conf, kpt, kpt_line, n_init, max_age, ema_alpha,
                 feature=None):
        self.track_id = track_id
        self.kpt = kpt
        self.kpt_line = kpt_line
        self.list_action = deque(maxlen=30)
    ...
    def update(self, detection, conf, kpt, kpt_line):
